...
object SendFeedback {
    ...
    fun execute(context: Context, subject: String, version: String) {
        val emailLink = "mailto:brandoncano.development@gmail.com?subject=[Feedback] - $subject ($version)"
        ...
        try {
            ...
            ex.printStackTrace()
            ErrorDialog.build(context, context.getString(R.string.error_body_send_feedback))
        }
    }
}
